...
# 🚨 NOTE: This file will be deprecated soon.
# The project is being refactored to use FastAPI, multi-LLM support, and AG UI protocol for a modern CopilotKit UI.
# See README.md for details.
# TODO: Move all LLM logic to new FastAPI backend and remove this file after migration.
